...
void verifyChunk( const FissionYieldData& chunk ) {
  ...
  CHECK_THAT( 2.05032e-19, WithinRel( chunk.fissionProducts()[0].FY() ) );
  CHECK_THAT( 7.851250e-4, WithinRel( chunk.fissionProducts()[1].FY() ) );
  CHECK_THAT( 0, WithinRel( chunk.fissionProducts()[2].FY() ) );
  CHECK_THAT( 1.31220e-19, WithinRel( chunk.fissionProducts()[0].DFY() ) );
  CHECK_THAT( 4.710750e-5, WithinRel( chunk.fissionProducts()[1].DFY() ) );
  CHECK_THAT( 0, WithinRel( chunk.fissionProducts()[2].DFY() ) );
  CHECK_THAT( 2.05032e-19, WithinRel( chunk.fissionProducts()[0].fissionYieldValue() ) );
  CHECK_THAT( 7.851250e-4, WithinRel( chunk.fissionProducts()[1].fissionYieldValue() ) );
  CHECK_THAT( 0, WithinRel( chunk.fissionProducts()[2].fissionYieldValue() ) );
  CHECK_THAT( 1.31220e-19, WithinRel( chunk.fissionProducts()[0].fissionYieldUncertainty() ) );
  CHECK_THAT( 4.710750e-5, WithinRel( chunk.fissionProducts()[1].fissionYieldUncertainty() ) );
  CHECK_THAT( 0, WithinRel( chunk.fissionProducts()[2].fissionYieldUncertainty() ) );
  ...
  CHECK_THAT( 2.05032e-19, WithinRel( chunk.FY()[0] ) );
  CHECK_THAT( 7.851250e-4, WithinRel( chunk.FY()[1] ) );
  CHECK_THAT( 0, WithinRel( chunk.FY()[2] ) );
  CHECK_THAT( 1.31220e-19, WithinRel( chunk.DFY()[0] ) );
  CHECK_THAT( 4.710750e-5, WithinRel( chunk.DFY()[1] ) );
  CHECK_THAT( 0, WithinRel( chunk.DFY()[2] ) );
  CHECK_THAT( 2.05032e-19, WithinRel( chunk.fissionYieldValues()[0] ) );
  CHECK_THAT( 7.851250e-4, WithinRel( chunk.fissionYieldValues()[1] ) );
  CHECK_THAT( 0, WithinRel( chunk.fissionYieldValues()[2] ) );
  CHECK_THAT( 1.31220e-19, WithinRel( chunk.fissionYieldUncertainties()[0] ) );
  CHECK_THAT( 4.710750e-5, WithinRel( chunk.fissionYieldUncertainties()[1] ) );
  CHECK_THAT( 0, WithinRel( chunk.fissionYieldUncertainties()[2] ) );
