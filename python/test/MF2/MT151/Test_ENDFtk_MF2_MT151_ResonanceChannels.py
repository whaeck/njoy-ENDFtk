...
class Test_ENDFtk_MF2_MT151_ResonanceChannels( unittest.TestCase ) :
    ...
    invalid_size = ( ' 5.000000-1 0.000000+0          0          0         13          22625 2151     \n'
                     ' 1.000000+0 0.000000+0 0.000000+0 0.000000+0 0.000000+0 0.000000+02625 2151     \n'
                     ' 2.000000+0 0.000000+0 5.000000-1 0.000000+0 5.437300-1 5.437300-12625 2151     \n'
                     ' 3.000000+0                                                       2625 2151     \n' )

    zero_size = ( ' 5.000000-1 0.000000+0          0          0          0          22625 2151     \n' )

    zero_nch = ( ' 5.000000-1 0.000000+0          0          0         12          02625 2151     \n'
                 ' 1.000000+0 0.000000+0 0.000000+0 0.000000+0 0.000000+0 0.000000+02625 2151     \n'
                 ' 2.000000+0 1.000000+0 5.000000-1 2.000000+0 5.437310-1 5.437300-12625 2151     \n' )
    ...
    def test_component( self ) :
        ...
        chunk = ResonanceChannels.from_string( self.chunk, 2625, 2, 151 )
    ...
    def test_failures( self ) :
        ...
        with self.assertRaises( Exception ) :
            ...
            chunk = ResonanceChannels.from_string( self.invalid_size, 2625, 2, 151 )

        # no data
        with self.assertRaises( Exception ) :

            chunk = ResonanceChannels.from_string( self.zero_size, 2625, 2, 151 )

        # no number resonances
        with self.assertRaises( Exception ) :

            chunk = ResonanceChannels.from_string( self.zero_nch, 2625, 2, 151 )
