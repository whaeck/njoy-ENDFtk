...
class File:
    ...
    def from_string(file: str) -> File:
        ...
        """
    def MT(self, mt: int) -> MT151.Section | MT152.Section:
        """
        ...
        """
    @typing.overload
    def __init__(self, parameters: MT151.Section) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, sections: list[MT151.Section | MT152.Section]) -> None:
        """
        Initialise the file
    ...
    def has_section(self, mt: int) -> bool:
        ...
        Arguments:
            ...
            mt      the MT number of the section
        """
    def section(self, mt: int) -> MT151.Section | MT152.Section:
        """
        Return the section with the requested MT number
