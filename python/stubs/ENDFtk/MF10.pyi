...
class ReactionProduct:
    """
    MF10 section - production cross sections for a specific excited state of                the reaction product
    """
    @staticmethod
    def from_string(string: str, mat: int, mf: int, mt: int) -> ReactionProduct:
        ...
        """
    @typing.overload
    def __init__(self, qm: float, qi: float, izap: int, lfs: int, boundaries: list[int], interpolants: list[int], energies: list[float], xs: list[float]) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, qm: float, qi: float, izap: int, lfs: int, energies: list[float], xs: list[float], interpolant: int = 2) -> None:
        """
        Initialise the component
