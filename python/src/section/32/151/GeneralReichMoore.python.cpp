...
void wrapGeneralReichMoore( python::module& module, python::module& viewmodule ) {

  // type aliases
  using Section = njoy::ENDFtk::section::Type< 32, 151 >;
  using Component = Section::GeneralReichMoore;
  using ReichMooreScatteringRadiusUncertainties = Section::ReichMooreScatteringRadiusUncertainties;
  using ShortRangeReichMooreBlock = Section::ShortRangeReichMooreBlock;
  using LongRangeCovarianceBlock = Section::LongRangeCovarianceBlock;
  using ShortRangeReichMooreBlockRange = RandomAccessAnyView< ShortRangeReichMooreBlock >;
  using LongRangeCovarianceBlockRange = RandomAccessAnyView< LongRangeCovarianceBlock >;

  // wrap views created by this section
  // none of these are supposed to be created directly by the user
  wrapRandomAccessAnyViewOf< ShortRangeReichMooreBlock >(
      viewmodule,
      "any_view< ShortRangeReichMooreBlock, random_access >" );
  ...
  .def_property_readonly(
    ...
    "short_range_blocks",
    [] ( const Component& self ) -> ShortRangeReichMooreBlockRange
