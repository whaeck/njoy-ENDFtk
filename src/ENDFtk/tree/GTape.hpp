#ifndef NJOY_ENDFTK_TREE_GTAPE
#define NJOY_ENDFTK_TREE_GTAPE
...
namespace tree {
  ...
  /**
   *  @class
   *  @brief The GENDF tree tape to index and access GENDF data
   *
   *  This class is used to load a GENDF tape and index its content into
   *  the different GENDF tree components: materials, sections and files. This
  ...
  class GTape {
    ...
    // blatantly stolen from the tree Tape
    #include "ENDFtk/tree/Tape/src/find.hpp"

  public:

    /* constructor */
    #include "ENDFtk/tree/GTape/src/ctor.hpp"

    /* methods */
    #include "ENDFtk/tree/GTape/src/material.hpp"
