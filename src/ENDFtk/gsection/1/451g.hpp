...
namespace section {
    ...
    public:
        ...
        auto SIGZ() const {
            ...
            return this->parameters_.list() | std20::views::drop(1) | std20::views::take(this->NZ());
        }
        ...
        auto EGN() const {
            using namespace njoy::tools;
            return this->parameters_.list() | std20::views::drop( 1 + this->NZ() ) | std20::views::take(this->NGN() + 1);
        }
